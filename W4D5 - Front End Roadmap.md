...
# Alternative course with emphasis on Ruby for backend

* https://www.theodinproject.com/

# React course (with Node.js backend)

* https://fullstackopen.com/en (used at University of Helsinki and more)
